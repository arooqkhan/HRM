                    ...
                    <div class="notification-scroll">
                        <div class="dropdown-item">
                            <div class="media server-log">
                                <img src="{{asset('admin-asset/src/assets/img/profile-16.jpeg')}}" class="img-fluid me-2" alt="avatar">
                        ...
                        <div class="dropdown-item">
                            <div class="media ">
                                <img src="{{asset('admin-asset/src/assets/img/profile-15.jpeg')}}" class="img-fluid me-2" alt="avatar">
                                <div class="media-body">
                                    <div class="data-info">
                        ...
                        <div class="dropdown-item">
                            <div class="media file-upload">
                                <img src="{{asset('admin-asset/src/assets/img/profile-21.jpeg')}}" class="img-fluid me-2" alt="avatar">
                                <div class="media-body">
                                    <div class="data-info">

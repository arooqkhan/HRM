...
class PayRollController extends Controller
{
    ...
    //     // Initialize total actual work hours
    //     $totalActualWorkHours = 0; // Make sure this variable is initialized
    ...
    //     // Calculate total expected work minutes and working days
    ...
    //     // Convert total work minutes to hours and minutes
    //     $totalActualWorkHours = intdiv($totalWorkMinutes, 60); // Ensure this is calculated
    //     $totalActualWorkMinutes = $totalWorkMinutes % 60;
    ...
    //         'totalActualWorkHours' => $totalActualWorkHours, // Include this variable
    ...
    //     return $pdf->download('payroll_' . $month . '_' . $year . '.pdf');
    // }

...
public function dashboard()
{
    ...
    // Get employees who clocked in after 10:30 AM today
    $lateEmployees = Attendance::whereDate('attendances.created_at', $today)
    ->whereTime('attendances.clock_in_time', '>', '10:30:00')
    ->join('employees', 'attendances.employee_id', '=', 'employees.id')
    ->select('employees.first_name', 'employees.last_name', 'attendances.employee_id')
    ->get();
